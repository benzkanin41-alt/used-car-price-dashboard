...
> **อัปเดต 25 ก.ย. 2569:** Dashboard ที่เผยแพร่ปัจจุบันใช้ตารางใหม่ของ ธปท. `EC_EI_040_S2` (`reportID=1036`, ปีอ้างอิง 2564=100) ซึ่งมีข้อมูล ม.ค. 2560-ก.ค. 2569 ณ วันที่ตรวจสอบ ข้อมูล ส.ค. 2569 ยังไม่เผยแพร่ และชุดใหม่เปลี่ยนวิธีคำนวณจากตาราง `EC_EI_040` จึงไม่ต่ออนุกรมสองชุดเข้าด้วยกัน โปรดดูคำสั่งอัปเดตและผลตรวจปัจจุบันใน [README.md](README.md) ส่วนขั้นตอนและตัวอย่างด้านล่างเป็นคู่มือฉบับดั้งเดิมของตารางเก่า เพื่อใช้อ้างอิงการออกแบบเท่านั้น
